...
const Dashboard = () => {
    ...
    const productLessThanFive = product?.filter(item => item.stock < 5)
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="flex flex-col items-center sm:grid sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
                <Link to={'/supplier/list'} className="block w-full p-6 bg-red-600 hover:bg-red-500 text-white rounded-md">
                ...
                <Link to={'/product/list'} className="block w-full p-6 bg-blue-600 hover:bg-blue-500 rounded-md text-white">
                    <h5 className="text-2xl mb-5">
                        PRODUCT
                    </h5>
                    <div className="flex flex-row">
                ...
                <Link to={'/stock/in'} className="block w-full p-6 bg-green-600 hover:bg-green-500 rounded-md text-white">
                    <h5 className="text-2xl mb-5">
                        STOCK IN
                    </h5>
                    <div className="flex flex-row">
                ...
                <Link to={'/stock/out'} className="block w-full p-6 bg-yellow-600 hover:bg-yellow-500 rounded-md text-white">
                    <h5 className="text-2xl mb-5">
                        STOCK OUT
                    </h5>
                    <div className="flex flex-row">
                ...
                {
                    productLessThanFive.length > 0 && (
                        <Card className="min-h-max mt-16">
                            <h2 className="dark:text-white text-xl md:text-3xl mb-4">Stock product less than 5</h2>
                            ...
                            <Table>
                                ...
                                <Table.Body className="divide-y">
                                    {loading ? (
                                        ...
                                        productLessThanFive.map((product, index) => (
