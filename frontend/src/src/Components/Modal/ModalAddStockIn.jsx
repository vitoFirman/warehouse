                        ...
                        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form onSubmit={handleSubmit} className="p-4 md:p-5">
                                <div className="flex flex-col gap-4 px-3">
                                    ...
                                    <div>
                                        <label htmlFor="supplier_code" className={`block mb-2 text-sm ${validationError?.supplier_code ? 'text-red-600' : 'dark:text-white'}`}>Supplier Code</label>
                                        <TextInput value={formData.supplier_code} name="supplier_code" id="supplier_code" type="text" onChange={handleChange} />
                                        {validationError?.supplier_code && <span className="text-red-600 text-xs">{validationError?.supplier_code[0]}</span>}
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <DatePicker selected={formData.date_in} onChange={(date) => setFormData({...formData, date_in: date})} withPortal locale={LocaleId} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
